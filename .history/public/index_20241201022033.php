...
<div class="row align-items-center bg-light py-5">
    <div class="col-lg-6">
        ...
        <a href="/public/book_room.php" class="btn btn-primary btn-lg">Pesan Kamar Sekarang</a>
    </div>
    <div class="col-lg-6 text-center">
        <img src="../assets/images/home_image.png" alt="KosKosan" class="img-fluid" width="100px" >
    </div>
</div>
        ...
        while ($room = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
            <div class="col-md-4">
                <div class="card shadow-sm mb-4">
                    <img src="/assets/images/room_placeholder.jpg" alt="Room Image" class="card-img-top">
                    <div class="card-body">
